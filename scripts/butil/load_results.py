...
#         'tracker': std.tracker,
#         'seqName': std.seqName,
#         'startFrame': std.startFrame,
#         'endFrame': std.endFrame,
#         'evalType': std.evalType,
#         'fps': std.fps,
#         'shiftType': std.shiftType,
#         'resType': std.resType,
#         'tmplsize': std.tmplsize,
#         'res': std.res
#     }
...
def save_seq_result(result):
    ...
    # sstring = json.dumps(result[0], default=student2dict)
    # sstring = json.dumps(result[0], default=lambda o: o.__dict__)
